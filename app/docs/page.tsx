...
export const metadata: Metadata = {
  ...
  description:
    'Explore methodology, governance, changelog, and advertising policies that power JudgeFinder transparency.',
  alternates: {
    canonical: '/docs',
  },
}
...
const docLinks = [
  {
    ...
    description:
      'Learn how we collect court data, normalize outcomes, and calculate confidence scores.',
    href: '/docs/methodology',
  },
  {
    title: 'Governance, ethics & redress',
    description:
      'Review bias mitigation safeguards, prohibited uses, and how to request corrections.',
      ...
      <div className="mx-auto w-full max-w-4xl px-4 py-12">
        <header className="mb-10 space-y-3">
          ...
          <p className="text-base text-muted-foreground sm:text-lg">
            Each guide explains how we source data, uphold governance standards, and communicate
            changes so that advocates, litigants, and journalists can trust the platform.
          </p>
        </header>
