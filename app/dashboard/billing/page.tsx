    ...
    <>
      ...
      <main id="main-content" role="main" className="min-h-screen bg-background">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          {showSuccess && (
            ...
            >
              <div className="flex items-start gap-3">
                <CheckCircle2
                  className="h-5 w-5 text-green-600 dark:text-green-500 flex-shrink-0 mt-0.5"
                  aria-hidden="true"
                />
                <div>
          ...
          <section aria-labelledby="payment-history-heading">
            ...
            {typedOrders.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <Link
                  href="/ads/buy"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors"
                >
                  <Package className="h-5 w-5" aria-hidden="true" />
                  <span className="text-white">Purchase Ad Space</span>
                </Link>
              </div>
            )}
          </section>
          ...
          {/* Help Text */}
          {typedOrders.length > 0 && (
            <aside className="mt-8 rounded-lg bg-muted/50 p-4" aria-label="Support information">
