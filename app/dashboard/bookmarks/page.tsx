        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <header className="mb-8">
            ...
            <div className="flex items-center mb-4">
              <BookmarkIcon className="h-8 w-8 text-yellow-400 mr-3" aria-hidden="true" />
              <div>
          ...
          <section aria-labelledby="bookmarked-judges-heading">
            <h2 id="bookmarked-judges-heading" className="sr-only">
              Bookmarked Judges
            </h2>
            {bookmarkedJudges.length > 0 ? (
              ...
              <div className="text-center py-12">
                <BookmarkIcon className="h-16 w-16 text-gray-600 mx-auto mb-4" aria-hidden="true" />
          ...
          {/* Quick Actions */}
          <nav aria-label="Quick actions navigation" className="mt-12">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700/50 p-6">
              <h2 id="quick-actions-heading" className="text-xl font-semibold text-white mb-4">
                Quick Actions
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <div>
                    <p className="font-medium text-white group-hover:text-orange-400">
                      Compare Judges
                    </p>
