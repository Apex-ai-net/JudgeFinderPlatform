      ...
      <Card>
        ...
        <CardContent className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Professional Verification Data (Attorneys Only)</h3>
            <ul className="list-disc pl-6 mt-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>Deliver marketing communications (with your explicit consent, opt-out available)</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold">
              For attorneys who advertise on JudgeFinder.io or seek professional verification, we collect and verify bar numbers
              to ensure platform integrity and compliance with attorney advertising regulations.
            </p>

            <h3 className="text-xl font-semibold mt-4 mb-2">Bar Number Security</h3>
            <ul className="list-disc pl-6 mt-2">
              <li>
                <strong>Encryption at Rest:</strong> Bar numbers are stored in encrypted database fields using AES-256 encryption
              </li>
              <li>
                <strong>Transmission Security:</strong> All bar number verification requests use TLS 1.3 encrypted connections
              </li>
              <li>
                <strong>Access Control:</strong> Only authorized system processes and verified administrators can access bar number data
              </li>
              <li>
                <strong>Verification Process:</strong> Bar numbers are verified against official state bar databases at registration
              </li>
              <li>
                <strong>Limited Retention:</strong> Bar numbers for non-advertisers are deleted after verification; advertisers' bar
                numbers are retained for compliance purposes only
              </li>
            </ul>
            ...
            <p className="mt-4">
              We never sell, share, or publicly display bar numbers. We do not use bar numbers for marketing purposes beyond
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-2">
              <li>
                <strong>Account Data:</strong> Retained for the lifetime of your account plus 30 days after deletion (to prevent
                accidental data loss and facilitate account recovery)
              </li>
              <li>
                <strong>Bar Number Verification:</strong> For non-advertisers, deleted immediately after verification; for active
                advertisers, retained for duration of advertising relationship plus 7 years (for regulatory compliance)
              </li>
              <li>
                <strong>Usage Analytics:</strong> Aggregated analytics retained indefinitely; individual-level data retained for
                24 months then anonymized
              </li>
              <li>
                <strong>Search History:</strong> Retained for 12 months for personalization, then automatically deleted
              </li>
              <li>
                <strong>Support Communications:</strong> Retained for 3 years for customer service quality and legal compliance
              </li>
              <li>
                <strong>Advertising Records:</strong> Retained for 7 years to comply with tax and advertising regulations
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>Delete personal information within 30 days (except where legal retention is required)</li>
            ...
            <p className="mt-4 font-semibold">
              Note: Public court data about judges is not considered personal information and is not deleted upon account closure,
              as it is sourced from public records and not user-generated content.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">6. California Consumer Privacy Act (CCPA) Compliance</h2>
            <p className="font-semibold">
              California residents have specific privacy rights under the California Consumer Privacy Act (CCPA) and the
            ...
            <ul className="list-disc pl-6 mt-2">
              <li>
                <strong>Right to Know:</strong> You can request disclosure of the categories and specific pieces of personal
              ...
              <li>
                <strong>Right to Opt-Out:</strong> You can opt out of the sale of your personal information (Note: We do not sell
                personal information)
              </li>
              <li>
                <strong>Right to Non-Discrimination:</strong> You will not receive discriminatory treatment for exercising your
                privacy rights
              </li>
              <li>
              ...
              <li>
                <strong>Right to Limit Use of Sensitive Personal Information:</strong> You can limit our use of sensitive personal
                information (such as bar numbers) to necessary business purposes only
              </li>
            </ul>
            ...
            <p className="mt-4">
              We will verify your identity before processing requests and respond within 45 days (extendable to 90 days for
              complex requests with notification).
            </p>

            <h3 className="text-xl font-semibold mt-4 mb-2">Categories of Personal Information Collected</h3>
            <p className="mt-2">
            ...
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>Professional information (bar numbers, law firm affiliations for verified attorneys)</li>
              ...
              <li>Inferences (preferences, characteristics, behaviors derived from usage patterns)</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              For detailed information about our cookie usage and how to manage your preferences, please see our{' '}
          ...
          <section className="mb-8">
            ...
            <p>We may update this privacy policy periodically. We will notify you of significant changes via email or platform notification. The "Last updated" date at the top of this policy indicates when the most recent changes were made.</p>
            <p className="mt-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-2">
              <li><a href="/terms" className="text-blue-600 hover:underline">Terms of Service</a> - Usage terms and legal agreements</li>
              <li><a href="/cookies" className="text-blue-600 hover:underline">Cookie Policy</a> - Detailed cookie information</li>
