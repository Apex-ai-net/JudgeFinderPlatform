...
function JudgeSummaryDemoContent(): JSX.Element {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <p className="text-sm text-muted-foreground">
          Pass <span className="font-mono">?judgeId=&lt;uuid&gt;</span> (and optional{' '}
          <span className="font-mono">&key=</span>) in the URL.
        </p>
      </div>
    )
  }
...
export default function JudgeSummaryDemoPage(): JSX.Element {
  return (
