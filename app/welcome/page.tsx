...
export default async function WelcomePage() {
  ...
  const content = professionContent[profession as keyof typeof professionContent] || professionContent.default

  // Quick start checklist based on profession
  const quickStartItems = profession === 'attorney'
    ? [
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 bg-card/30 backdrop-blur-sm rounded-lg border border-border/50 p-6">
            <h3 className="text-lg font-semibold text-white mb-4">Watch: Getting Started (2 min)</h3>
            ...
            <p className="text-sm text-gray-400 mt-3">
              Learn the basics of searching for judges, reading analytics, and maximizing your research efficiency.
            </p>
          </div>
