        ...
        <CardContent className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold text-amber-700">
              IMPORTANT: Judicial bias indicators and analytical metrics are statistical analyses of case outcomes, not character judgments or assessments of judicial fitness.
            </p>
            <p className="mt-4">
              The bias patterns, tendency indicators, and statistical metrics displayed on this platform represent:
            </p>
            <ul className="list-disc pl-6 mt-2">
              <li>Mathematical analyses of publicly available case outcome data</li>
              <li>Statistical correlations that may reflect case mix, jurisdiction characteristics, or procedural factors rather than judicial bias</li>
              <li>Aggregated patterns that do not account for case-specific facts, legal complexities, or applicable law</li>
              <li>Trend indicators derived from historical data that may not predict future case outcomes</li>
            </ul>
            <p className="mt-4">
              These analytics should be interpreted as one data point among many factors to consider when researching judicial
              backgrounds. They do not constitute evidence of judicial misconduct, unfitness, or impropriety. Users should not
              rely solely on these metrics when making legal strategy decisions.
            </p>
            <p className="mt-4">
              Our methodology documentation is available at judgefinder.io/docs/methodology and is updated periodically to
              reflect improvements in our analytical approach.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold">
              While we implement rigorous data validation processes, JudgeFinder.io makes no warranties regarding the completeness,
              accuracy, timeliness, or reliability of judicial data presented on this platform.
            </p>
            <h3 className="text-xl font-semibold mt-4 mb-2">Data Sources</h3>
            <p>
              Judicial information is primarily sourced from:
            </p>
            <ul className="list-disc pl-6 mt-2">
              <li>CourtListener by the Free Law Project - public court records and judicial profiles</li>
            ...
            <ul className="list-disc pl-6 mt-2">
              <li>
                <strong>Minimum Case Threshold:</strong> Judges must have decided at least 500 publicly available cases
                for bias analytics to be calculated. Profiles with insufficient case data will display limited analytics.
              </li>
              <li>
                <strong>Data Lag:</strong> Court data may be 30-90 days behind real-time court activity due to processing
                and publication delays by source systems.
              </li>
              <li>
                <strong>Sealed and Confidential Cases:</strong> Analytics do not include sealed cases, juvenile matters,
                family law cases with privacy orders, or other confidential proceedings.
              </li>
              <li>
                <strong>Historical Accuracy:</strong> Position histories and case assignments prior to 2010 may be incomplete
                or unavailable depending on court digitization efforts.
              </li>
              <li>
                <strong>Name Matching:</strong> Judges with common names or similar name spellings may occasionally have
                cases misattributed. We employ multi-factor matching algorithms to minimize errors.
              </li>
            </ul>
            <p className="mt-4">
              Users should independently verify critical information through official court sources before relying on it for
              legal proceedings or professional decisions. Report data inaccuracies to legal@judgefinder.io.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="font-semibold">
              JudgeFinder.io displays paid advertising from legal professionals and law firms. All advertisements are clearly
              labeled as "Sponsored" or "Advertisement" to distinguish them from editorial content.
            </p>
            ...
            <ul className="list-disc pl-6 mt-2">
              <li>Judge profile pages - contextual placement based on practice areas and jurisdiction</li>
            ...
            <p className="mt-4">
              <strong>Editorial Independence:</strong> Advertising relationships do not influence judicial analytics, search rankings,
              or editorial content. Bias calculations and statistical analyses are computed using objective algorithms without
              consideration of advertising relationships.
            </p>
            ...
            <p className="mt-4">
              JudgeFinder.io does not endorse, recommend, or guarantee the quality of services provided by advertisers.
              Users should independently research and vet any attorney before engaging their services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Legal professionals who advertise on JudgeFinder.io or claim "Verified Attorney" status agree to:
            </p>
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>Promptly notify JudgeFinder.io of any disciplinary actions, suspensions, or license status changes</li>
              <li>Comply with all applicable professional responsibility rules and attorney advertising regulations</li>
              <li>Not misrepresent their credentials, specializations, or case results</li>
            </ul>
            <p className="mt-4">
              We verify bar numbers through state bar databases at the time of account creation. However, we do not
              continuously monitor disciplinary records. Users should independently verify attorney credentials through
              their state bar association before engaging legal services.
            </p>
            <p className="mt-4 font-semibold">
              "Verified Attorney" badges indicate only that we have confirmed active bar membership at registration.
              They do not constitute endorsements, certifications of specialization, or quality assessments.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              which describes how we collect, use, and protect your information. Additional information about cookies and tracking
              is available in our <a href="/cookies" className="text-blue-600 hover:underline">Cookie Policy</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">14. Fair Credit Reporting Act (FCRA) Notice</h2>
            <p className="font-semibold">
          ...
          <section className="mb-8">
            ...
            <p>
              Please review our additional legal policies for comprehensive information:
            </p>
            <ul className="list-disc pl-6 mt-2">
              <li><a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a> - Data collection and protection practices</li>
              <li><a href="/cookies" className="text-blue-600 hover:underline">Cookie Policy</a> - Cookie usage and management</li>
              <li><a href="/acceptable-use" className="text-blue-600 hover:underline">Acceptable Use Policy</a> - Detailed usage guidelines and prohibited activities</li>
            </ul>
          </section>
        </CardContent>
      </Card>
