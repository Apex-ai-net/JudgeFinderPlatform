      ...
      <Card>
        ...
        <CardContent className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              This Cookie Policy explains how JudgeFinder.io uses cookies and similar tracking
              technologies to recognize you when you visit our platform. It explains what these
              technologies are, why we use them, and your rights to control our use of them.
            </p>
            <p className="mt-4">
              By using JudgeFinder.io, you consent to our use of cookies in accordance with this
              Cookie Policy. If you do not agree to our use of cookies, you should adjust your
              browser settings accordingly or refrain from using our platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              and reporting information anonymously. This helps us improve user experience.
            </p>
            <div className="bg-gray-50 p-4 rounded-md mt-2">
              <table className="min-w-full border-collapse">
                <thead>
            ...
            <p>
              These cookies are used to track advertising impressions and measure the effectiveness
              of attorney advertisements on our platform.
            </p>
            <div className="bg-gray-50 p-4 rounded-md mt-2">
              <table className="min-w-full border-collapse">
                <thead>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4">
              <li>
                <strong>Clerk (Authentication):</strong> Manages user authentication and session
                security
              </li>
              <li>
                <strong>Google Analytics:</strong> Provides anonymous usage statistics and traffic
                analysis
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p>
              You can manage your cookie preferences directly on JudgeFinder.io through your account
              settings:
            </p>
            <ul className="list-disc pl-6 mt-2">
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              want to have your online activities tracked. JudgeFinder.io currently does not respond
              to Do Not Track signals because there is no industry-standard for compliance.
            </p>
            <p className="mt-4">
              However, you can still manage cookies and tracking through your browser settings and
              our cookie preference center as described above.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              collected through cookies. JudgeFinder.io does not sell personal information. For more
              details about your California privacy rights, see our{' '}
            ...
            <p>
              If you are located in the European Economic Area (EEA), you have the right to object
              to our use of cookies and request that we delete information collected through
              cookies. Contact privacy@judgefinder.io to exercise these rights.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              changes by posting a notice on our platform or sending an email to registered users.
            </p>
            <p className="mt-4">
              The "Effective Date" at the top of this policy indicates when it was last revised. We
              encourage you to review this Cookie Policy periodically.
            </p>
          </section>
