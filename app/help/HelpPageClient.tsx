...
import { HelpHeroSection } from '@/components/help'
  ...
  return (
    <div className="border-b border-border last:border-0">
      <button
        ...
        className="w-full py-4 px-2 flex justify-between items-start text-left hover:bg-accent transition-colors"
      >
...
export function HelpPageClient(): JSX.Element {
  return (
    <>
      <HelpHeroSection />
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-8 p-4 bg-primary/10 rounded-lg border border-primary/20">
              <h3 className="font-semibold text-foreground mb-2">Understanding the Data</h3>
              <p className="text-muted-foreground text-sm">
                All information on JudgeFinder.io comes from public court records. We use AI to
                analyze patterns and provide insights, but these should be considered alongside
                other factors when evaluating judges. Always consult with a qualified attorney for
                legal matters.
              </p>
            </div>
          </CardContent>
