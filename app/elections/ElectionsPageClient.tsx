...
export default function ElectionsPageClient(): JSX.Element {
  ...
  const filteredElections = useMemo(() => {
    ...
    if (selectedCounty !== 'all') {
      filtered = filtered.filter((e) => e.jurisdiction === selectedCounty || e.county === selectedCounty)
    }
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="mx-auto mb-12 max-w-3xl text-lg md:text-xl text-muted-foreground leading-relaxed"
            >
              Make informed decisions in judicial elections. Research candidates, view their records,
              and understand their judicial philosophy before casting your ballot. Every judge matters.
            </motion.p>
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground mt-1">Elections Next 30 Days</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">
                  {electionsData?.next_90_days || 0}
                </div>
                <div className="text-sm text-muted-foreground mt-1">Elections Next 90 Days</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">
                  {availableCounties.length}
                </div>
                <div className="text-sm text-muted-foreground mt-1">Counties Covered</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section id="upcoming-elections" className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Find judges on your ballot and research their backgrounds, rulings, and judicial philosophy
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-background border-2 border-dashed border-border rounded-xl p-8">
              ...
              <p className="text-sm text-muted-foreground">
                We're building personalized ballot lookup based on your address.
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Access comprehensive profiles, ruling patterns, and analytics for every California judge
            </p>
            <Link
              href="/judges"
...
function ElectionCard({ election }: { election: UpcomingElection }): JSX.Element {
  return (
    <AnimatedCard intensity="medium" className="p-6">
      <Link href={`/judges/${election.judge_id}`} className="block">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">{election.position_sought}</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="pt-2 border-t border-border">
            ...
            <div className="mt-2 flex items-center justify-between">
              <span className="text-xs text-muted-foreground">Days Until Election</span>
  ...
  return (
    <div className="text-center py-12">
      ...
      <p className="text-muted-foreground mb-6 max-w-md mx-auto">
        There are currently no scheduled judicial elections for your selected filters.
        Try selecting a different county or check back later.
      </p>
      <Link
        href="/judges"
...
function ResourceLink({ href, label }: { href: string; label: string }): JSX.Element {
  return (
    <a
      ...
      className="flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-3 text-sm text-foreground transition-colors hover:border-primary hover:bg-accent group"
    >
...
function CalendarDateCard({ date, title, description, variant }: CalendarDateCardProps): JSX.Element {
  const colors = {
  ...
  return (
    <AnimatedCard intensity="subtle" className="p-6">
      <div className="flex items-start gap-4">
        <div className={`flex-shrink-0 rounded-lg ${colors[variant]} p-3`}>
