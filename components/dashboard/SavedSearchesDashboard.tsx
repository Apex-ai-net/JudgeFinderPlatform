      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <header className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-foreground mt-2">Saved Searches</h1>
              ...
              <div className="bg-card rounded-xl shadow-sm border border-border p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-foreground mt-2">{searches.length}</p>
                  </div>
              ...
              <div className="bg-card rounded-xl shadow-sm border border-border p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-foreground mt-2">
                      {
                        searches.filter((s) => s.filters && Object.keys(s.filters).length > 0)
                          .length
                      }
                    </p>
                  </div>
          ...
          <section aria-labelledby="saved-searches-heading">
            <div className="bg-card rounded-xl shadow-sm border border-border">
              <div className="px-6 py-4 border-b border-border">
                <h2 id="saved-searches-heading" className="text-lg font-semibold text-foreground">
                  Your Saved Searches
                </h2>
              </div>
              ...
              {searches.length === 0 ? (
                ...
                <div className="divide-y divide-border">
                  {searches.map((search) => (
                    <div key={search.id} className="px-6 py-4 hover:bg-muted transition-colors">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="ml-4 flex items-center space-x-2 flex-shrink-0">
                          <Link
                            ...
                            className="inline-flex items-center px-3 py-2 border border-border rounded-lg text-sm font-medium text-foreground bg-card hover:bg-muted"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-3 py-2 border border-destructive/30 rounded-lg text-sm font-medium text-destructive bg-card hover:bg-destructive/10 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link
                href="/judges"
                className="block p-6 bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl border border-primary/30 hover:shadow-md transition-shadow"
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="font-semibold text-foreground">Search Judges</h3>
              ...
              <Link
                href="/dashboard"
                className="block p-6 bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl border border-border hover:shadow-md transition-shadow"
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="font-semibold text-foreground">Back to Dashboard</h3>
