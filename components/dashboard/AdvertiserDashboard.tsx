      ...
      <main id="main-content" role="main" className="min-h-screen bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Welcome back,{' '}
                  {roleInfo.advertiserProfile?.firm_name ||
                    user?.full_name ||
                    user?.email ||
                    'User'}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <section aria-labelledby="active-campaigns-heading" className="lg:col-span-2">
              <div className="bg-card rounded-xl shadow-sm border border-border p-6">
          ...
          <section aria-labelledby="campaign-analytics-heading" className="mb-8">
            <h2 id="campaign-analytics-heading" className="sr-only">
              Campaign Analytics
            </h2>
