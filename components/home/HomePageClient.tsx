...
export default function HomePageClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black text-foreground dark:text-white overflow-hidden">
          ...
          <div className="lg:hidden">
            ...
            >
              <h1 className="text-2xl sm:text-3xl font-bold mb-3 leading-tight">
                ...
                <span className="bg-gradient-to-r from-primary to-blue-800 bg-clip-text text-transparent block text-3xl sm:text-4xl">
      ...
      <section className="py-12 lg:py-20 px-4 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-black lg:bg-gradient-to-r lg:from-primary lg:to-blue-800">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl lg:text-4xl font-bold text-foreground dark:text-white lg:text-white mb-3 lg:mb-4">
            ...
            <div className="lg:hidden">
              <button
                ...
                className="w-full px-6 py-4 rounded-xl bg-gradient-to-r from-primary to-blue-700 text-white font-semibold text-lg shadow-lg transform active:scale-95 transition-all"
              >
            ...
            <div className="hidden lg:flex flex-row gap-4 justify-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white text-primary font-semibold hover:bg-muted transition-all transform hover:scale-105"
              >
