    ...
    return (
      <div className="bg-card/50 backdrop-blur-sm rounded-lg border border-border/50 p-6">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Unable to Load User Data</h2>
          <p className="text-muted-foreground mb-4">
            We couldn&apos;t load your profile information. Please try refreshing the page or
            signing in again.
          </p>
          <button
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-card/50 border border-border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              readOnly
            />
          </div>
      ...
      <div className="bg-card/50 backdrop-blur-sm rounded-lg border border-border/50 p-6">
        ...
        <div className="space-y-4">
          <button className="flex items-center justify-between w-full p-4 bg-card/30 rounded-lg hover:bg-muted-foreground/30 transition-colors">
          ...
          <button className="flex items-center justify-between w-full p-4 bg-card/30 rounded-lg hover:bg-red-600/20 transition-colors group">
            <div className="flex items-center">
