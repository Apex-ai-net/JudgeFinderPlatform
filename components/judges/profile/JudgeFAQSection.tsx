...
export function JudgeFAQSection({
  judgeName,
  courtName,
  jurisdiction,
}: JudgeFAQSectionProps): JSX.Element {
    ...
    <div className="rounded-lg border border-border bg-card shadow-sm p-6">
      ...
      <div className="mt-8 p-4 rounded-lg border border-primary/30 bg-primary/10">
        <p className="text-sm text-primary">
          ...
          comprehensive analytics and insights for legal professionals. Contact our research team
          for specialized judicial intelligence and case strategy consulting.
        </p>
      </div>
    </div>
  )
